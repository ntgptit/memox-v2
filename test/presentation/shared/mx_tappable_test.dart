...
void main() {
  testWidgets(
    'DT1 onDisplay: MxTappable wires Material clipping and InkWell shape',
    (tester) async {
  ...
  testWidgets(
    'DT1 onNavigate: MxFolderTile routes tap handling through MxTappable',
    (tester) async {
      var tapped = false;
  ...
  testWidgets(
    'DT2 onNavigate: MxStudySetTile keeps the widened gap between icon and content',
    (tester) async {
      await tester.pumpWidget(
        const _TestApp(
  ...
  testWidgets(
    'DT1 onBehavior: MxAvatar keeps spacing between avatar and badge',
    (tester) async {
      await tester.pumpWidget(
        const _TestApp(
  ...
  testWidgets(
    'DT3 onNavigate: MxPageDots uses shaped tap surfaces for dot taps',
    (tester) async {
      int? tappedIndex;
  ...
  testWidgets(
    'DT1 onSelect: MxPageDots exposes page position and selected semantics',
    (tester) async {
  ...
  testWidgets(
    'DT1 onUpdate: MxPageDots marks tappable dots as semantic buttons',
    (tester) async {
      final semanticsHandle = tester.ensureSemantics();
      try {
        late String selectedLabel;
