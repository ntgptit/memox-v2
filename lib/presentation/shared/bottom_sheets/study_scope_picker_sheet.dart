...
/// `docs/wireframes/25-shared-bottom-sheets.md` §scope-picker.
enum _StudyScopeKind { today, deck, folder }

/// Shared scope picker used by Dashboard ("Start new learning") and Study
/// Result ("Study more"). Step one chooses a scope kind; Deck/Folder then
/// open a searchable destination picker. The chosen scope routes through
/// the Study Entry Gate using `go`/`replace` semantics so the originating
/// screen is NOT preserved underneath.
///
/// [reviewCount] is optional and, when provided, decorates the Today row
