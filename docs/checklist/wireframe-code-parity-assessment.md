...
| 20 | `20-settings-learning.md` | 🟡 Partial / V1 study-defaults Current | Current V1: new-study/review defaults, interval table, tags entry. Target: daily goal, streak, reminder. | [Prompt 21, 2026-05-31]: docs clarified current screen reality. Code edits study defaults through `StudyDefaultsSettings`; daily-goal/streak/reminder controls are Future/Target and tied to engagement scope, not Settings Hub parity. | Keep engagement settings out of hub prompt; handle in a dedicated engagement/settings task. | Study-defaults owner is clear. | Original wireframe layout still contains target engagement controls. |
