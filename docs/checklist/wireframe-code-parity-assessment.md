...
| **P1-9** | ✅ DONE (2026-05-31, Prompt 08) Fill hint-taint grading channel: `AttemptGrade.recovered` / schema v12 allow hint-tainted exact match and Mark-correct override to finalize as `ReviewResult.recovered` without fake `incorrect` attempts. | §3.10, #17 | M |
