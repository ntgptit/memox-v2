...
| --- | --- | --- | --- | --- | --- |
| DT1 | compact viewport should keep dialog inside the visible width | host viewport is compact and dialog content requests an oversized width | `MxDialog` renders | dialog width is no wider than the viewport | C0+C1 |
