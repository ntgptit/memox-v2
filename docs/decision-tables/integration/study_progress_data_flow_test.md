...
| DT8 | Progress empty state action navigates to Library | database contains a library folder but no active sessions | user opens Progress and taps Open | Library overview opens and displays the seeded folder | C0+C1 |
